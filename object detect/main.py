...
if a or b in ('coco.names','r') :
    ...
    tts.save("hello.mp3")
    filename = "C:\Users\shaha\OneDrive\Desktop\object-identifier-and-camera-to-object-and-object-to-object-distance-estimator-main\object-identifier-and-camera-to-object-and-object-to-object-distance-estimator-main\object detect\hello.mp3"
    tts.save(filename)
